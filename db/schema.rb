...
ActiveRecord::Schema[7.1].define(version: 20_240_309_140_950) do
  ...
  create_table 'people', force: :cascade do |t|
    ...
    t.index %w[name first_name dob], name: 'index_people_on_name_and_first_name_and_dob', unique: true
  end
  ...
  create_table 'registrations', force: :cascade do |t|
    ...
    t.index %w[person_id camp_id], name: 'index_registrations_on_person_id_and_camp_id', unique: true
